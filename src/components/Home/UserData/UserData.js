...
const UserData = () => {
  ...
  useEffect(() => {
    const url = "https://user-mange.herokuapp.com/auth/all-users";
  ...
  const handleDeleteUser = (id) => {
    swal({
      ...
      if (wantDelete) {
        axios
          .delete(`https://user-mange.herokuapp.com/user/${id}`)
          .then((res) => {
            if (res.data) {
              return swal(
                "Successfully Deleted!",
                "One User has been successfully deleted.",
                "success"
          ...
          <tr>
            ...
            <div className="d-flex showPassword align-item-center">
              <input
                ...
                value={user.password}
              />
              <span className=" mt-2">{ToggleIcon}</span>
  ...
  return (
    <Container>
      <>
        ...
        <>
          <Modal centered show={show} size="lg">
            <Modal.Header>
              <Modal.Title className="text-center mt-2 text-success">
                Update User
              </Modal.Title>
      ...
      <div className="d-flex justify-content-between mt-5">
        ...
        <div>
          <h6>
            Showing {displayUsers.length} out of {allUsers.length}
          </h6>
        </div>
      </div>
    </Container>
